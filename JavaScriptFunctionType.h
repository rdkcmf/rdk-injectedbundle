...
namespace JavaScript {
    ...
    public:
        ...
        JavaScriptFunctionType(const std::string& jsClassName, const std::string& jsFunName, bool shouldNotEnum = false)
            : JavaScriptFunction(jsFunName, function, shouldNotEnum)
